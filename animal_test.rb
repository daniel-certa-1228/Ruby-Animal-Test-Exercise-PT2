...
class AnimalTest < Minitest::Test
	...
	def test_if_species_is_string
		assert_instance_of String, @owl.species
	end

	def test_if_name_is_accessible
		@animal.name = "Ostrich"
	...
	def test_if_species_is_accessible
		@animal.species = "Bird"
	...
	def test_walk_when_legs_zero
		assert_raises TypeError do @animal.walk
		end
	end
